...
def downgrade():
    ...
    op.add_column('features', sa.Column(
        'gene_symbol', sa.VARCHAR(), autoincrement=False, nullable=True))
    op.add_column('features', sa.Column(
        'gene_name', sa.VARCHAR(), autoincrement=False, nullable=True))
    op.add_column('features', sa.Column('gene_encode_id',
                  sa.VARCHAR(), autoincrement=False, nullable=True))
    op.add_column('features', sa.Column('transcript_name',
                  sa.VARCHAR(), autoincrement=False, nullable=True))
    op.drop_table('genes')
    # ### end Alembic commands ###
