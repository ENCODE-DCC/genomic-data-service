...
def upgrade():
    ...
    op.add_column('files', sa.Column(
        'biosample_classification', sa.String(), nullable=True))
    op.add_column('files', sa.Column(
        'biosample_organ', sa.String(), nullable=True))
    op.add_column('files', sa.Column(
        'biosample_summary', sa.String(), nullable=True))
    op.add_column('files', sa.Column(
        'biosample_system', sa.String(), nullable=True))
    op.add_column('files', sa.Column(
        'biosample_term_name', sa.String(), nullable=True))
