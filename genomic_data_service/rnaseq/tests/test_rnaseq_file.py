...
def test_rnaseq_file_url(raw_files):
    ...
    assert (
        rna_file.url
        == "https://www.encodeproject.org/files/ENCFF241WYH/@@download/ENCFF241WYH.tsv"
    )
...
def test_rnaseq_file_get_expression_generator(local_quantification_tsv_path):
    ...
    expressions = get_expression_generator("", local_quantification_tsv_path)
    assert list(expressions) == [
        ...
        [
            "ENSG00000150907.7",
            "ENST00000379561.5,ENST00000473775.1,ENST00000636651.1",
            "2.73",
            "4.23",
        ],
        [
            "ENSG00000150938.9",
            "ENST00000280527.6,ENST00000413985.1,ENST00000426856.1,ENST00000428774.1,ENST00000473403.5,ENST00000477491.5,ENST00000481321.1,ENST00000497236.1",
            "4.52",
            "7.01",
        ],
        [
            "ENSG00000150961.14",
            "ENST00000280551.10,ENST00000419654.6,ENST00000502526.1,ENST00000502830.1,ENST00000503683.1,ENST00000505134.5,ENST00000505280.1,ENST00000506622.5,ENST00000509818.5,ENST00000511033.1,ENST00000511481.5,ENST00000511715.1,ENST00000514418.1,ENST00000514561.5",
            "8.65",
            "13.42",
        ],
        [
            "ENSG00000150967.17",
            "ENST00000280560.12,ENST00000344275.11,ENST00000346530.9,ENST00000392439.7,ENST00000426173.6,ENST00000442028.6,ENST00000442833.6,ENST00000536976.5,ENST00000537276.5,ENST00000538895.5,ENST00000540285.5,ENST00000540971.5,ENST00000541424.1,ENST00000541983.1,ENST00000542448.5,ENST00000542678.5,ENST00000543935.1,ENST00000545373.1,ENST00000546077.1,ENST00000546289.5,ENST00000622723.1",
            "0.96",
            "1.49",
        ],
        ...
        [
            "ENSG00000150990.7",
            "ENST00000308736.6,ENST00000507267.2,ENST00000539298.1,ENST00000542400.5,ENST00000543962.1,ENST00000544745.1",
            "1.60",
            "2.48",
        ],
        [
            "ENSG00000150991.14",
            "ENST00000339647.5,ENST00000535131.1,ENST00000535859.1,ENST00000536661.1,ENST00000536769.1,ENST00000538617.5,ENST00000540351.1,ENST00000540700.1,ENST00000541272.1,ENST00000541645.1,ENST00000542416.1,ENST00000544481.1,ENST00000546120.2,ENST00000546271.1",
            "183.38",
            "284.55",
        ],
        [
...
def test_rnaseq_file_get_expressions_remote_file():
    ...
    assert expressions[0] == Expression(*["10904", "10904", "0.00", "0.00"])
...
def test_rnaseq_file_extract_as_documents_with_repository(
    raw_files, raw_expressions, mocker, repositories
):
    from genomic_data_service.rnaseq.domain.file import RnaSeqFile
