...
CATALOG_API_FREQ = 'https://api.catalogkg.igvf.org/api/variants/freq?page=0&maximum_af=1&limit=500'
CATALOG_API_VARIANTS = 'https://api.catalogkg.igvf.org/api/variants?page=0&limit=500'
