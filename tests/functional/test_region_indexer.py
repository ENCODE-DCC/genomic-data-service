...
def test_need_to_fetch_documents_str_doc_pwms_list(
    dataset_no_doc_index, document_string
):
    dataset = dataset_no_doc_index
    dataset["documents"].append(document_string)
...
def test_fetch_documents(dataset_no_doc_index, document_string):
    ...
    assert (
        ...
        == "/documents/49f43842-5ab4-4aa1-a6f4-2b1234955d93/"
    )
